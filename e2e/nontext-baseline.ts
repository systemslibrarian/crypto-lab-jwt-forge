...
> = {
  ...
  "control-boundary|button#cl-theme-toggle.cl-btn.cl-icon": { ratio: 2.19, required: 3.0, unverified: false },
  ...
  "control-boundary|textarea#ta-payload": { ratio: 1.12, required: 3.0, unverified: false }
};
